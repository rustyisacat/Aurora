    ...
    fun `dashboard endpoint includes battery, grouped notifications, alarm, calendar, weather, and sound machine`() {
        ...
        assertEquals(
            """{"battery":77,"charging":true,"notifications":3,""" +
                ...
                """"weather":{"temperature":74,"condition":"Clear","high":86,"low":68,"timezone":"America/New_York","sunrise":"06:15","sunset":"20:42","rainExpectedAt":null,"feelsLike":null,"windSpeedMph":null,"humidityPercent":null,"uvIndex":null,"dailyForecast":[],"airQualityIndex":null,"radarStation":null},""" +
